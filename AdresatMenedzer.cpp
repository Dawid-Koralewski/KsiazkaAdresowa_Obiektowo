...
void AdresatMenedzer::ustawidUsunietegoAdresata(int noweID)
{
...
void AdresatMenedzer::zaktualizujDaneWybranegoAdresata(Adresat adresat)
{
    ...
    plikZAdresatami.edytujDaneWybranegoAdresataWPliku(adresat.pobierzIdAdresata(), liniaZDanymiAdresata);
